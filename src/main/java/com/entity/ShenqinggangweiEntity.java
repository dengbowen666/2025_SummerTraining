...
public class ShenqinggangweiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public ShenqinggangweiEntity() {
		
	}
	
	public ShenqinggangweiEntity(T t) {
		try {
	 ...
	 * 设置：申请进度
	 */
	public void setShenqingjindu(String shenqingjindu) {
		this.shenqingjindu = shenqingjindu;
	}
	/**
	 * 获取：申请进度
	 */
	public String getShenqingjindu() {
		return shenqingjindu;
	}
	/**
	 * 设置：申请日期
	 */
