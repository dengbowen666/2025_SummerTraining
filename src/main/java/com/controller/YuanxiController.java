...
public class YuanxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,YuanxiEntity yuanxi, 
        ...
        EntityWrapper<YuanxiEntity> ew = new EntityWrapper<YuanxiEntity>();
    ...
    public R save(@RequestBody YuanxiEntity yuanxi, HttpServletRequest request){
    	yuanxi.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
    ...
    public R update(@RequestBody YuanxiEntity yuanxi, HttpServletRequest request){
        //ValidatorUtils.validateEntity(yuanxi);
        yuanxiService.updateById(yuanxi);//全部更新
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<YuanxiEntity> wrapper = new EntityWrapper<YuanxiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = yuanxiService.selectCount(wrapper);
