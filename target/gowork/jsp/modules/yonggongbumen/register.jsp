	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<input  name="bumenbianhao" placeholder="部门编号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<input  name="bumenmingcheng" placeholder="部门名称" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">办公地点</label> 
							<input  name="bangongdidian" placeholder="办公地点" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">负责教师</label> 
							<input  name="fuzejiaoshi" placeholder="负责教师" class="form-control-i">
							</div>
							<div class="form-group">
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "yonggongbumen/register";
				$.ajax({ 
					type: "POST",
					url: url,
